		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#brcomprodutosprodutos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomprodutosprodutos-display": {
								"semanticObject": "brcomprodutosprodutos",
								"action": "display",
								"description": "Relatório de produtos em estoque",
								"title": "relatório de produtos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.produtos.produtos",
									"url": sap.ui.require.toUrl("br/com/produtos/produtos")
								}
							}
						}
					}
